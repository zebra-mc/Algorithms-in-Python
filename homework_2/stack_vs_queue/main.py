...
ссылки на крайние узлы и счетчик элементов.
...
Для сравнения: очередь на массиве через list.pop(0) работала бы за
