...
границей списка, если popped закончилась раньше, чем стек опустел (при нарушении условия о совпадении элементов)."""
...
class Tests(unittest.TestCase):
    ...
    def test_max_length(self):
        """Граница: n = 100 000, случаи True и False"""
    ...
    def test_random_valid(self):
        """Проверка сгенерированной допустимой последовательности"""
